...
public class DataBaseSimulation
{
    ...
    public DataBaseSimulation()
    {
        Articulos = new List<Articulo>
        {
            ...
            new Articulo { Id = 3, Nombre = "LUBRIFIANT 63655", Descripcion = "Lubricante médico 63655", Precio = 90, Descuento = (decimal)0, RutaImagen = "https://resources.sears.com.mx/medios-plazavip/mkt/60f7193998648_4-lubri-6-3-ljpg.jpg?scale=550" },
